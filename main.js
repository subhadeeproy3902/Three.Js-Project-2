...
let mixer;
let isMobile = window.matchMedia('(max-width: 450px)').matches;
...
let projects = [
  {
    image: 'textures/1.webp',
    url: 'https://github-profile-searcher-two.vercel.app/',
  },
  {
    image: 'textures/2.webp',
    url: 'https://weatherme-chi.vercel.app/',
  },
  {
    image: 'textures/3.webp',
    url: 'https://royal-calculator.vercel.app/',
  },
  {
    image: 'textures/4.webp',
    url: 'https://royal-todo.vercel.app/',
  },
  {
    image: 'textures/5.webp',
    url: 'https://tikitaka.vercel.app/',
  },
  {
    image: 'textures/6.webp',
    url: 'https://codesshot.vercel.app/',
  },
  {
    image: 'textures/7.webp',
    url: 'https://www.microsoft-aurora.tech/',
  },
  {
    image: 'textures/8.webp',
    url: 'https://eclecticatmsl.tech/',
  },
];
let aboutCameraPos = {
  x: 0.10,
...
function loadIntroText() {
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const titleGeo = new TextGeometry('SUBHADEEP ROY', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
